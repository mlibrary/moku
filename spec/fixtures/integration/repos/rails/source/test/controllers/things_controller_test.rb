...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post things_url, params: { thing: { admin: @thing.admin, content: @thing.content, more_stuff: @thing.more_stuff, name: @thing.name, title: @thing.title } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { admin: @thing.admin, content: @thing.content, more_stuff: @thing.more_stuff, name: @thing.name, title: @thing.title } }
